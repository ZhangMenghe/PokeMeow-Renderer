...
//                       cy,-0.5f,cy,0.5f);
//        }
        edgeList[0] = new pmEdge(gl4, pmLineFactory.LINE_SIN, pmLineVisual.LINE_QUADRIC_CURVE, pmArrowShapeFactory.SHAPE_ARROWHEAD,pmArrowShapeFactory.SHAPE_ARROWHEAD,
